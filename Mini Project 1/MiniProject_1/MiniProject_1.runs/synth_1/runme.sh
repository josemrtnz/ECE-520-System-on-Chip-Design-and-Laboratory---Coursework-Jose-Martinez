...
HD_PWD='D:/Labs/MiniProject_1/MiniProject_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP1_BRAM_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP1_BRAM_wrapper.tcl

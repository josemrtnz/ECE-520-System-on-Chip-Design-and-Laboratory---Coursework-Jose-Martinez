...
HD_PWD='D:/Labs/MiniProject_1/MiniProject_1.runs/MP1_BRAM_axi_bram_ctrl_0_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP1_BRAM_axi_bram_ctrl_0_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP1_BRAM_axi_bram_ctrl_0_bram_0.tcl

...
HD_PWD='D:/Labs/MiniProject_1/MiniProject_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MP1_BRAM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MP1_BRAM_wrapper.tcl -notrace

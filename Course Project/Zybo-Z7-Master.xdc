...
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { PWM_VER }]; #IO_L18N_T2_34 Sch=je[2]                     
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { PWM_HOR }]; #IO_25_35 Sch=je[3]                          
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { PWM_HOR }]; #IO_L19P_T3_35 Sch=je[4]                     
